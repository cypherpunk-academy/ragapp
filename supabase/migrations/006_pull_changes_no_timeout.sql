-- =============================================================================
-- Disable statement timeout for pull_changes.
--
-- On first sync (last_pulled_at = 0), the function scans all rag_paragraphs
-- which can be tens of thousands of rows. The Supabase default statement
-- timeout (8s for authenticated role) is too short for the initial pull.
-- Subsequent syncs are fast (only changed rows since last_pulled_at).
--
-- SET statement_timeout TO 0 applies only within this function call.
-- =============================================================================
