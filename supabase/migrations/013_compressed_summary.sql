-- =============================================================================
-- rag_talks: compressed_summary / compressed_up_to_turn_index — Welle 5b
-- ("Verdichten"). Fasst aeltere Turns zusammen, um den angezeigten
-- Kontextverbrauch zu reduzieren. Beide Spalten werden bereits von der
-- ragrun-Alembic-Migration 0025_add_compressed_up_to_turn_index angelegt;
-- IF NOT EXISTS macht dies hier idempotent, falls diese Migration vor der
-- Alembic-Migration laeuft.
-- =============================================================================

ALTER TABLE rag_talks ADD COLUMN IF NOT EXISTS compressed_up_to_turn_index integer;
ALTER TABLE rag_talks ADD COLUMN IF NOT EXISTS compressed_summary text;

-- =============================================================================
-- pull_changes — include compressed_summary/compressed_up_to_turn_index on rag_talks
-- =============================================================================
